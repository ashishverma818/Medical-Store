 ...
 * @author ashish
 */
@ManagedBean(name = "bookc",eager=true)
@RequestScoped
public class bookcall implements Serializable
{
    ...
    public void setSerstatus(String serstatus) {
     ...
     public void insertelectrician() throws SQLException, ClassNotFoundException
    ...
    { 
     ...
     public void insertwelder() throws SQLException, ClassNotFoundException
    ...
    { 
     ...
     public void insertcarpenter() throws SQLException, ClassNotFoundException
    ...
    { 
        ...
        catch(Exception e)
        {
         ...
         public void insertpainter() throws SQLException, ClassNotFoundException
         { 
            try
            {
                    Class.forName("com.mysql.jdbc.Driver");
